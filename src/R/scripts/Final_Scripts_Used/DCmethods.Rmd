...
numAneus <- reshape2::melt(aneuploidies, id.vars=1)

pdf("anEvents.pdf")
gcEvents <- ggplot(numAneus, x=Chromosome, y=value,color=variable)
gcEvents + geom_col(aes(x=factor(Chromosome), y=value,fill=variable)) + theme_classic() + labs(y="Number", title="Number of Aneuploidies per Type in Each Experiment") + scale_fill_discrete(name=NULL)
dev.off()
...
ratioDistributionsEuploids(ddsDefGC_1,genesGC_5,"Sample_1_GC")
ratioDistributionsEuploids(ddsDefGC_2,genesGC_5,"Sample_2_GC")
ratioDistributionsEuploids(ddsDefGC_3,genesGC_5,"Sample_3_GC")
ratioDistributionsEuploids(ddsDefGC_5,genesGC_5,"Sample_5_GC")
ratioDistributionsEuploids(ddsDefGC_9,genesGC_9,"Sample_9_GC")

ratioDistGC2 <- ratioDistributionsEuploids(ddsDefGC_2,genesGC_5,"Sample_2_GC")
ratioDistGC3 <- ratioDistributionsEuploids(ddsDefGC_3,genesGC_5,"Sample_3_GC")
...
ratioDistributionsTrisomy(ddsDefGC_4,genesGC_5,"chrV","Sample_4_GC_ChrV")
ratioDistGC4 <- ratioDistributionsTrisomy(ddsDefGC_4,genesGC_5,"chrV","Sample_4_GC_ChrV")
meanGC4 <- mean(ratioDistGC4)
medianGC4 <- median(ratioDistGC4)
stdevGC4 <- sd(ratioDistGC4)
ratioDistGC1 <- ratioDistributionsTrisomy(ddsDefGC_1,genesGC_5,"chrI","Sample_1_GC_ChrI")
ratioDistGC7 <- ratioDistributionsTrisomy(ddsDefGC_7,genesGC_7,"chrI","Sample_7_GC_ChrI")
