...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
wilcox.test((log2(l152.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.1[,3])), (log2(l029.1[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
wilcox.test((log2(l152.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.1.red[,3])), (log2(l029.1.red[,3])), paired=FALSE, var.equal=TRUE)
...
boxplot((log2(l029.2[,3])),(log2(l050.2[,3])),(log2(l112.2[,3])),(log2(l115.2[,3])),(log2(l117.2[,3])),
        ...
        ,names=c("29","50","112","115","117","123","141","152"),
        ylab="log2(fold change)", col=c("green", "cyan","cyan","cyan","cyan","cyan","cyan","cyan"),
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.2[,3])), (log2(l029.2[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.2.red[,3])), (log2(l029.2.red[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.3[,3])), (log2(l029.3[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.3.red[,3])), (log2(l029.3.red[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.4[,3])), (log2(l029.4[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.4.red[,3])), (log2(l029.4.red[,3])), paired=FALSE, var.equal=TRUE)
...
boxplot((log2(l029.5[,3])),(log2(l050.5[,3])),(log2(l112.5[,3])),(log2(l115.5[,3])),(log2(l117.5[,3])),
        ...
        ,names=c("29","50","112","115","117","123","141","152"),
        ylab="log2(fold change)", col=c("green", "cyan","cyan","cyan","deeppink1","darkcyan","cyan","cyan"),
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l117.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l123.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l050.5[,3])), (log2(l029.5[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l117.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l123.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.5.red[,3])), (log2(l029.5.red[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.6[,3])), (log2(l029.6[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.6.red[,3])), (log2(l029.6.red[,3])), paired=FALSE, var.equal=TRUE)
...
boxplot((log2(l029.7[,3])),(log2(l050.7[,3])),(log2(l112.7[,3])),(log2(l115.7[,3])),(log2(l117.7[,3])),
        ...
        ,names=c("29","50","112","115","117","123","141","152"),
        ylab="log2(fold change)", col=c("green", "cyan","cyan","cyan","cyan","cyan","cyan","darkcyan"),
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l152.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.7[,3])), (log2(l029.7[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l152.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.7.red[,3])), (log2(l029.7.red[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l152.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.8[,3])), (log2(l029.8[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l152.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.8.red[,3])), (log2(l029.8.red[,3])), paired=FALSE, var.equal=TRUE)
...
#use non-parametric because these are not normally distributed
#run same test on all lines, even those that are not "supposed" to be aneuploid
t.test((log2(l152.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
wilcox.test((log2(l152.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
#p-value = 3.387e-11
t.test((log2(l112.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l115.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l117.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l123.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l141.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
t.test((log2(l050.9[,3])), (log2(l029.9[,3])), paired=FALSE, var.equal=TRUE)
