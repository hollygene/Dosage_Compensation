...
genesGC.test <- genesGC.test[-(grep(paste0(remove1,"$"),genesGC.test$TXCHROM,perl=TRUE)),]
...
cpmGC.test <- merge(genes,cpmGC, by.x="GENEID", by.y="names")
cpmGC <- cpmGC.test
...
cpmGC
et1.Dev <- exactTestByDeviance(cpmGC[,3:5],cpmGC[,61:63])
top.test <- topTags(et1.test,n=200,adjust.method = "BH")
View(top.test)

test1.test <- decideTests(et1.test, adjust.method = "BH")
summary(test1.test)
View(test1.test)

#with design matrix
et1.test1 <- exactTest(x.GC.test.1, pair=c(".GCAnc.",".11."),dispersion = "auto")
top.test1 <- topTags(et1.test1,n=200,adjust.method = "BH")
View(top.test1)

test1.test1 <- decideTests(et1.test1, adjust.method = "BH")
summary(test1.test1)
View(test1.test1)

#line 21
et21.test <- exactTest(x.GC.test, pair=c(".GCAnc.",".21."),dispersion = "auto")
top.test21 <- topTags(et21.test,n=200,adjust.method = "BH")
View(top.test21)

test21.test <- decideTests(et21.test, adjust.method = "BH")
summary(test21.test)
View(test21.test)
