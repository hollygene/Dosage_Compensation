...
topTags(et3)
write.csv(et3,file="3vsAnc.edgeR.pairwise.csv")
et31 <- exactTest(y,pair=c(16,1))
topTags(et31)
write.csv(et31,file="31vsAnc.edgeR.pairwise.csv")
et4 <- exactTest(y,pair=c(17,1))
topTags(et4)
write.csv(et4,file="4vsAnc.edgeR.pairwise.csv")
et49 <- exactTest(y,pair=c(18,1))
topTags(et49)
write.csv(et49,file="49vsAnc.edgeR.pairwise.csv")
et5 <- exactTest(y,pair=c(19,1))
topTags(et5)
write.csv(et5,file="5vsAnc.edgeR.pairwise.csv")
et59 <- exactTest(y,pair=c(21,1))
topTags(et59)
write.csv(et59,file="59vsAnc.edgeR.pairwise.csv")
et6 <- exactTest(y,pair=c(22,1))
topTags(et6)
write.csv(et6,file="6vsAnc.edgeR.pairwise.csv")
et61 <- exactTest(y,pair=c(23,1))
topTags(et61)
write.csv(et61,file="61vsAnc.edgeR.pairwise.csv")
et66 <- exactTest(y,pair=c(24,1))
topTags(et66)
write.csv(et66,file="66vsAnc.edgeR.pairwise.csv")
et69 <- exactTest(y,pair=c(25,1))
topTags(et69)
write.csv(et69,file="69vsAnc.edgeR.pairwise.csv")
et7 <- exactTest(y,pair=c(26,1))
topTags(et7)
write.csv(et7,file="7vsAnc.edgeR.pairwise.csv")
et76 <- exactTest(y,pair=c(27,1))
topTags(et76)
write.csv(et76,file="76vsAnc.edgeR.pairwise.csv")
et77 <- exactTest(y,pair=c(28,1))
topTags(et77)
write.csv(et77,file="77vsAnc.edgeR.pairwise.csv")
et8 <- exactTest(y,pair=c(29,1))
topTags(et8)
write.csv(et8,file="8vsAnc.edgeR.pairwise.csv")
et9 <- exactTest(y,pair=c(30,1))
topTags(et9)
write.csv(et9,file="9vsAnc.edgeR.pairwise.csv")
et2 <- exactTest(y,pair=c(12,1))
topTags(et2)
write.csv(et2,file="2vsAnc.edgeR.pairwise.csv")
#MA Lines
et112 <- exactTest(y,pair=c(5,2))
topTags(et112)
write.csv(et112,file="112vsAnc.edgeR.pairwise.csv")
et115 <- exactTest(y,pair=c(6,2))
topTags(et115)
write.csv(et115,file="115vsAnc.edgeR.pairwise.csv")
et117 <- exactTest(y,pair=c(7,2))
topTags(et117)
write.csv(et117,file="117vsAnc.edgeR.pairwise.csv")
et123 <- exactTest(y,pair=c(8,2))
topTags(et123)
write.csv(et123,file="123vsAnc.edgeR.pairwise.csv")
et141 <- exactTest(y,pair=c(9,2))
topTags(et141)
write.csv(et141,file="141vsAnc.edgeR.pairwise.csv")
et152 <- exactTest(y,pair=c(10,2))
topTags(et152)
write.csv(et152,file="152vsAnc.edgeR.pairwise.csv")
et29 <- exactTest(y,pair=c(14,2))
topTags(et29)
write.csv(et29,file="29vsAnc.edgeR.pairwise.csv")
et20 <- exactTest(y,pair=c(20,2))
topTags(et50)
write.csv(et50,file="50vsAnc.edgeR.pairwise.csv")
